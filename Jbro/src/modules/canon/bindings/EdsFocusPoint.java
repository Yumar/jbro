...
public class EdsFocusPoint extends Structure {
    ...
    protected void initFieldOrder() {
        setFieldOrder( new String[] { "valid", "selected", "justFocus", "rect",
                                     "reserved" } );
    }
     ...
     */
    public EdsFocusPoint( final NativeLong valid, final NativeLong selected,
                          final NativeLong justFocus, final EdsRect rect,
    ...
    public EdsFocusPoint( final Pointer pointer ) {
        super( pointer );
        read();
    }
